	...
	<div class="col-lg-4">
		<div class="jumbotron" style="padding-top:20px;">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="생년월일(XXXX-XX-XX)" id="birth"  name="birth" maxlength="20">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="전화번호(XXX-XXXX-XXXX)" id="phone" name="phone" maxlength="20">
			</div>
